          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            >
              <div className="relative">
                <motion.div
                  className="bg-color-blue-600 dark:bg-blue-700 absolute -top-4 -left-4 w-24 h-24 rounded-tl-lg z-0"
                ...
                <motion.div
                  className="bg-color-blue-600 dark:bg-blue-700 absolute -bottom-4 -right-4 w-24 h-24 rounded-br-lg z-0"
                  variants={decorativeBlockAnimation}
                ></motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.h3
                className="text-7xl font-semibold mb-12 text-color-gray-800 dark:text-white uppercase about-title"
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.7 }}
                viewport={{ once: true }}
              >
                Why Choose <span className="text-color-blue-600 dark:text-color-blue-400">Epimech</span>
              </motion.h3>
              ...
              >
                ...
                >
                  <div className="h-10 w-10 rounded-full bg-color-blue-100 dark:bg-blue-900 flex items-center justify-center mr-3 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-color-blue-600 dark:text-color-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="font-medium text-lg text-color-gray-800 dark:text-white">Trusted Industry Experience</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-medium text-lg text-color-gray-800 dark:text-white">Fast Turnaround Time</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-medium text-lg text-color-gray-800 dark:text-white">Reliable Customer Service</h4>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Link href="/about" className="mt-8 inline-flex items-center bg-color-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white py-3 px-6 rounded-md transition-colors duration-300">
                  Learn More About Us
              ...
              >
                ...
                >
                  <div className="h-12 w-12 rounded-full bg-color-blue-100 dark:bg-blue-900 flex items-center justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-color-blue-600 dark:text-color-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <h4 className="text-xl font-semibold mb-3 text-color-gray-800 dark:text-white">Quality Assurance</h4>
                ...
                >
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-color-gray-800 dark:text-white">Engineering Innovation</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                >
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-color-gray-800 dark:text-white">Rapid Response</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                >
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-color-gray-800 dark:text-white">Expert Support</h4>
                  <p className="text-gray-600 dark:text-gray-300">
