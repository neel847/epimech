  ...
  const teamMembers = [
    {
      ...
      credentials: "Michael holds a Master's in Mechanical Engineering from the University of Toronto and serves on the board of the Canadian Engineering Standards Association.",
      contact: {
    ...
    },
    {
      ...
      credentials: "Samantha earned her Ph.D. in Mechanical Systems Engineering from McGill University and is a frequent keynote speaker at international engineering forums.",
      contact: {
    ...
    <div className="w-full bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="py-20 -mt-20 relative z-10">
        <div className="container mx-auto px-4 lg:px-8 mt-16">
          ...
          >
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-50 dark:bg-blue-900/20 rounded-full opacity-30 transform -translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-50 dark:bg-blue-900/20 rounded-full opacity-30 transform translate-x-1/2 translate-y-1/2"></div>

            <div className="absolute top-0 left-0 w-32 h-32 bg-blue-50 dark:bg-blue-900/20 rounded-full opacity-30 transform -translate-x-1/2 translate-y-1/2"></div>
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-blue-50 dark:bg-blue-900/20 rounded-full opacity-30 transform translate-x-1/2 -translate-y-1/2"></div>
